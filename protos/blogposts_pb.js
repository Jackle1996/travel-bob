...
goog.exportSymbol('proto.travelbob.blogs.TravelDate', null, global);
/**
 ...
 * @constructor
 */
proto.travelbob.blogs.TravelDate = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.travelbob.blogs.TravelDate, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.travelbob.blogs.TravelDate.displayName = 'proto.travelbob.blogs.TravelDate';
}
...
proto.travelbob.blogs.Blog.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    startdate: (f = msg.getStartdate()) && proto.travelbob.blogs.TravelDate.toObject(includeInstance, f),
    enddate: (f = msg.getEnddate()) && proto.travelbob.blogs.TravelDate.toObject(includeInstance, f)
  };
...
proto.travelbob.blogs.Blog.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new proto.travelbob.blogs.TravelDate;
      reader.readMessage(value,proto.travelbob.blogs.TravelDate.deserializeBinaryFromReader);
...
proto.travelbob.blogs.Blog.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.travelbob.blogs.TravelDate.serializeBinaryToWriter
    );
  }
...
/**
 * optional TravelDate startDate = 7;
 * @return {?proto.travelbob.blogs.TravelDate}
 */
proto.travelbob.blogs.Blog.prototype.getStartdate = function() {
  return /** @type{?proto.travelbob.blogs.TravelDate} */ (
    jspb.Message.getWrapperField(this, proto.travelbob.blogs.TravelDate, 7));
};


/** @param {?proto.travelbob.blogs.TravelDate|undefined} value */
...
/**
 * optional TravelDate endDate = 8;
 * @return {?proto.travelbob.blogs.TravelDate}
 */
proto.travelbob.blogs.Blog.prototype.getEnddate = function() {
  return /** @type{?proto.travelbob.blogs.TravelDate} */ (
    jspb.Message.getWrapperField(this, proto.travelbob.blogs.TravelDate, 8));
};
...
proto.travelbob.blogs.Blogpost.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    traveldate: (f = msg.getTraveldate()) && proto.travelbob.blogs.TravelDate.toObject(includeInstance, f),
...
/**
 * optional TravelDate travelDate = 6;
 * @return {?proto.travelbob.blogs.TravelDate}
 */
proto.travelbob.blogs.Blogpost.prototype.getTraveldate = function() {
  return /** @type{?proto.travelbob.blogs.TravelDate} */ (
    jspb.Message.getWrapperField(this, proto.travelbob.blogs.TravelDate, 6));
};
 ...
 * @return {!Object}
 */
proto.travelbob.blogs.TravelDate.prototype.toObject = function(opt_includeInstance) {
  return proto.travelbob.blogs.TravelDate.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.travelbob.blogs.TravelDate} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.travelbob.blogs.TravelDate.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.travelbob.blogs.TravelDate}
 */
proto.travelbob.blogs.TravelDate.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.travelbob.blogs.TravelDate;
  return proto.travelbob.blogs.TravelDate.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.travelbob.blogs.TravelDate} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.travelbob.blogs.TravelDate}
 */
proto.travelbob.blogs.TravelDate.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.travelbob.blogs.TravelDate.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.travelbob.blogs.TravelDate.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.travelbob.blogs.TravelDate} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.travelbob.blogs.TravelDate.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getYear();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.travelbob.blogs.TravelDate.prototype.getYear = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.travelbob.blogs.TravelDate.prototype.setYear = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.travelbob.blogs.TravelDate.prototype.getMonth = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.travelbob.blogs.TravelDate.prototype.setMonth = function(value) {
 ...
 * @return {number}
 */
proto.travelbob.blogs.TravelDate.prototype.getDay = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {number} value */
proto.travelbob.blogs.TravelDate.prototype.setDay = function(value) {
